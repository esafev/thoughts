...
The hardest part of programming, for me, is figuring out what exactly I want to do. Ops, backend, frontend, hardware, and systems programming — each one pulls me in a different direction. Within each of those areas, there are even more rabbit holes: web performance, local-first software, distributed systems, crypto, decentralization, AI, design engineering, and so on.

For me, programming has always been more than a skill. It’s a way to explore, to tinker, and to satisfy curiosity. From wires and screwdrivers to apps, the tools have changed. But the impulse remains. That’s why I keep coming back to it. It’s simply who I am.
